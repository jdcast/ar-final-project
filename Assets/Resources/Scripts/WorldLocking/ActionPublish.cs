...
namespace Scripts.WorldLocking
{
    ...
    public class ActionPublish : ActionCube
    {
        ...
        public Microsoft.MixedReality.WorldLocking.ASA.SpacePinBinderFile spacePinBinderFile;
        ...
        private void DisplayStatus()
        {
            if (statusLine != null)
            {
                ...
                string wltStatus = Microsoft.MixedReality.WorldLocking.Core.WorldLockingManager.GetInstance().ErrorStatus;
