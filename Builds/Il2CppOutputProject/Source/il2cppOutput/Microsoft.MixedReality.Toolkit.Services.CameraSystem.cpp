...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityCameraSystem_Initialize_m8ABCA7A120E58BBF76D8CEFE401CAA60D70B7D41 (MixedRealityCameraSystem_tD4D74C89F72748EA3F923ED0ED967446BBADB8E2 * __this, const RuntimeMethod* method)
{
	...
	bool V_2 = false;
	int32_t V_3 = 0;
	MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D  V_4;
	...
	Type_t * G_B8_0 = NULL;
	{
		...
		NullCheck(L_2);
		int32_t L_3;
		L_3 = InterfaceFuncInvoker0< int32_t >::Invoke(0 /* System.Int32 System.Collections.Generic.IReadOnlyCollection`1<Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSettingsProvider>::get_Count() */, IReadOnlyCollection_1_t65DAAA768A4DCC9B22C8BAD18B2F878A2F88EAD0_il2cpp_TypeInfo_var, L_2);
		if (L_3)
		{
			goto IL_002c;
		}
	...
	{
		MixedRealityCameraProfile_t62011D84A3ABC218F6A187A49021B50791D41C20 * L_4 = V_0;
...
IL_003c:
	{
		...
		L_8 = MixedRealityCameraProfile_get_SettingsConfigurations_mE51C438554D2C98DB64B28F941D60C4AF7C5CFA1(L_7, /*hidden argument*/NULL);
		int32_t L_9 = V_3;
		NullCheck(L_8);
		int32_t L_10 = L_9;
		...
		L_12 = MixedRealityCameraSettingsConfiguration_get_ComponentType_mBE43DEF9D858E85B1876431AB86B70279E5B72D8_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
...
IL_0059:
	{
		NullCheck(G_B7_0);
		Type_t * L_14;
		L_14 = SystemType_get_Type_mC447B3C20EA164CE4877D3F893AF3C4BA592AA9F_inline(G_B7_0, /*hidden argument*/NULL);
		G_B8_0 = L_14;
	}
...
IL_005e:
	{
		...
		bool L_15;
		L_15 = Type_op_Equality_mA438719A1FDF103C7BBBB08AEF564E7FAEEA0046(G_B8_0, (Type_t *)NULL, /*hidden argument*/NULL);
		V_6 = L_15;
		bool L_16 = V_6;
		if (!L_16)
		{
...
IL_006d:
	{
		...
		String_t* L_20;
		L_20 = MixedRealityCameraSettingsConfiguration_get_ComponentName_mE46280C978D79D1D63221FB3AA23A3EA0976E080_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		NullCheck(L_19);
		...
		uint32_t L_22;
		L_22 = MixedRealityCameraSettingsConfiguration_get_Priority_mA76F0B796FCE99C5CA5322D1F47175CE044BAE76_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		uint32_t L_23 = L_22;
		RuntimeObject * L_24 = Box(UInt32_tE60352A06233E4E69DD198BCC67142159F686B15_il2cpp_TypeInfo_var, &L_23);
		NullCheck(L_21);
		...
		BaseCameraSettingsProfile_t96F629C1EDACEBBB6376D6C904A05C9BB28FD45D * L_26;
		L_26 = MixedRealityCameraSettingsConfiguration_get_SettingsProfile_mB4C6609C74F61E18E5471CCC5B1C0DD8CBA4E598_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		NullCheck(L_25);
		...
		//     args))
		SystemType_t8D2323983B85594F1037C020D3497109700B78DF * L_27;
		L_27 = MixedRealityCameraSettingsConfiguration_get_ComponentType_mBE43DEF9D858E85B1876431AB86B70279E5B72D8_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		NullCheck(L_27);
		Type_t * L_28;
		L_28 = SystemType_get_Type_mC447B3C20EA164CE4877D3F893AF3C4BA592AA9F_inline(L_27, /*hidden argument*/NULL);
		String_t* L_29;
		L_29 = MixedRealityCameraSettingsConfiguration_get_ComponentName_mE46280C978D79D1D63221FB3AA23A3EA0976E080_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		int32_t L_30;
		L_30 = MixedRealityCameraSettingsConfiguration_get_RuntimePlatform_m6478289E3E7481B333E9076F44D5CCDBACAD3388_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		ObjectU5BU5D_tC1F4EE0DB0B7300255F5FD4AF64FE4C585CF5ADE* L_31 = V_5;
		bool L_32;
		L_32 = BaseDataProviderAccessCoreSystem_RegisterDataProvider_TisIMixedRealityCameraSettingsProvider_t45B1C342ACAB79A9064C61BA2ED7F22C43C2B969_mA794E2282C686DC2A40E00BBA52A208E2923BB74(__this, L_28, L_29, L_30, L_31, /*hidden argument*/BaseDataProviderAccessCoreSystem_RegisterDataProvider_TisIMixedRealityCameraSettingsProvider_t45B1C342ACAB79A9064C61BA2ED7F22C43C2B969_mA794E2282C686DC2A40E00BBA52A208E2923BB74_RuntimeMethod_var);
		V_7 = L_32;
		bool L_33 = V_7;
		if (!L_33)
		{
	...
	}
	{
		...
		String_t* L_34;
		L_34 = MixedRealityCameraSettingsConfiguration_get_ComponentName_mE46280C978D79D1D63221FB3AA23A3EA0976E080_inline((MixedRealityCameraSettingsConfiguration_t1BF4B2AE03BC5B33530F2B4B12862C9AB381419D *)(&V_4), /*hidden argument*/NULL);
		RuntimeObject* L_35;
		L_35 = GenericVirtFuncInvoker1< RuntimeObject*, String_t* >::Invoke(BaseDataProviderAccessCoreSystem_GetDataProvider_TisIMixedRealityCameraSettingsProvider_t45B1C342ACAB79A9064C61BA2ED7F22C43C2B969_mD0012AC5FEB72642E9D3622DCCD4F7FFE78FF710_RuntimeMethod_var, __this, L_34);
		V_8 = L_35;
...
IL_00da:
	{
		...
		NullCheck(L_37);
		InterfaceActionInvoker0::Invoke(1 /* System.Void Microsoft.MixedReality.Toolkit.CameraSystem.IMixedRealityCameraSettingsProvider::ApplyConfiguration() */, IMixedRealityCameraSettingsProvider_t45B1C342ACAB79A9064C61BA2ED7F22C43C2B969_il2cpp_TypeInfo_var, L_37);
	}
...
IL_00ef:
	{
		// for (int i = 0; i < profile.SettingsConfigurations.Length; i++)
		int32_t L_39 = V_3;
		MixedRealityCameraProfile_t62011D84A3ABC218F6A187A49021B50791D41C20 * L_40 = V_0;
		NullCheck(L_40);
		MixedRealityCameraSettingsConfigurationU5BU5D_t2C96291C8CEB498128C550B089EE513A51C044F0* L_41;
		L_41 = MixedRealityCameraProfile_get_SettingsConfigurations_mE51C438554D2C98DB64B28F941D60C4AF7C5CFA1(L_40, /*hidden argument*/NULL);
		NullCheck(L_41);
...
IL_0104:
	{
		...
		bool L_43 = __this->get_useFallbackBehavior_25();
		V_10 = L_43;
		bool L_44 = V_10;
		if (!L_44)
		{
	...
	}
	{
		...
		bool L_45;
		L_45 = MixedRealityCameraSystem_get_IsOpaque_m9455B78E765C8609347E7B0A7B377698527A9F0A(__this, /*hidden argument*/NULL);
		__this->set_cameraOpaqueLastFrame_24(L_45);
		// if (IsOpaque)
		bool L_46;
...
IL_0140:
	{
		...
		MixedRealityPlayspace_set_Position_mC2919EB2593621FFF8BB47C3BEDEE23EEA2BEB04(L_48, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_mD9BC0AF99F27F474F2B8248FECA12381F2B57D74(L_49, /*hidden argument*/NULL);
	...
	}
	{
		...
		String_t* L_59;
		L_59 = String_Format_mB3D38E5238C3164DB4D7D29339D9E225A4496D17(_stringLiteral4FF56F0DB79ED48F92A89FC9BCCE0794BDA6075F, L_58, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
...
IL_0191:
	{
		...
		L_60 = CameraCache_get_Main_m197C7A2C9D2EAE6AD083908F4CBC07262BDB75E7(/*hidden argument*/NULL);
		NullCheck(L_60);
		...
		bool L_64;
		L_64 = Quaternion_op_Inequality_m37169F3E8ADDA24A5A221AD7397835B437B71439(L_62, L_63, /*hidden argument*/NULL);
		V_13 = L_64;
		bool L_65 = V_13;
		if (!L_65)
		{
